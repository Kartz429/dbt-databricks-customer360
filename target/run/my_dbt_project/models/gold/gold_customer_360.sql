        ...
        create or replace table `workspace`.`dbt_demo`.`gold_customer_360`
...
orders as (
    ...
    from `workspace`.`dbt_demo`.`silver_orders`
...
marketing as (
    ...
    from `workspace`.`dbt_demo`.`silver_marketing`
...
support as (
    ...
    from `workspace`.`dbt_demo`.`silver_support`
...
web_events as (
    ...
    from `workspace`.`dbt_demo`.`silver_web_events`
